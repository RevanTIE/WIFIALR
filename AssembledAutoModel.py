"""
Script automático del proceso completo implementando el modelo construido
"""
...
def preprocesamiento(file):
    ...
    sin_ruido_df = pd.DataFrame(trn_sin_ruido_collected)
...
def fpca(datos, file_nam):
    ...
    pcaDataFrame = pd.DataFrame(pca_data2)
...
def main():
    ...
    datos_crudos = extracting_csi(file_path)
    datos_preprocesados = preprocesamiento(datos_crudos)
