...
X_new_list = askopenfilename(title='Choose a file', initialdir=root, filetypes = (("CSV Files","*.csv"),))
...
print('Nearest Neighbors : %d' % (KNN_moda))
"""
...
print('Support Vector Machine : %d' % (SVM_moda))
"""
Neural Network
"""
...
print('Neural Network : %d' % (NeuralN_moda))
